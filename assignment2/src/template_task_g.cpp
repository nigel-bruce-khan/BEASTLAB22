...
double mm(int N, int REP, double expected_result) {
  ...
  //********** Verification removed because expected result unknown for N=4000
   // printf("Wrong result for N=%4d. expected %.3f but got %.3f. Abo
  // verify expected result. accounting for possibly system dependent float rounding errors
  //if(abs(array_sum - expected_result) > 0.1){  //condition removed 
