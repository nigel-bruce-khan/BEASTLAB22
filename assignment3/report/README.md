...
#### b) Try to explain the results of your experiments. Especially, what is the influence of the size N, setting of k, and the difference of the two code variants sum_indexcalc() and sum_indexload()?
